#ifndef CAMERA_FIREWIRE_CAMERAVIEWERTASK_TASK_HPP
#define CAMERA_FIREWIRE_CAMERAVIEWERTASK_TASK_HPP

#include "camera_firewire/CameraViewerTaskBase.hpp"
...
namespace camera_firewire {
    class CameraViewerTask : public CameraViewerTaskBase
    {
    ...
    public:
        CameraViewerTask(std::string const& name = "camera_firewire::CameraViewerTask", TaskCore::TaskState initial_state = Stopped);
